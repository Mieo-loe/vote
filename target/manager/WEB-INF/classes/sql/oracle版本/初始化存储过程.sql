...
insert into sys_menu_test(ID,TITLE,HREF,REQUEST_URL,ICON,CODE,TARGET,PARENT_ID,SORT,CREATE_USER,CREATE_TIME,UPDATE_USER,UPDATE_TIME) values('4a7f3cae133e4a51b8f35769b55163dd','菜单管理','page/system/sysMenu/grade_Adm.html','/menu/**','icon-text','1-1',null,'244247008b53450fa16bc503bc861b7c','1','gameloft9',to_date('2017-12-28 16:24:32','yyyy-MM-dd HH24:mi:ss'),null,to_date('2017-12-28 16:24:32','yyyy-MM-dd HH24:mi:ss'));
