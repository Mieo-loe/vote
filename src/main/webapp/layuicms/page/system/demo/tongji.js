                        ...
                        for (var z = 0; z < data.list[i].bz_coll[j].zbz_coll.length; z++) {
                            ...
                            if (res.data.list[i].bz_coll[j].id === 78) {
                                ...
                                only += '<div class="xuanxian">' +
                                    '<input id="item0" type="radio" title="' + res.data.list[i].bz_coll[j].zbz_coll[z].substandardName + '" name="item' + a + '" value="' + data.list[i].bz_coll[j].zbz_coll[z].substandardId + '" class="radio_">' +
                                    '<label for="item0"></label>' +

                                    "   <span style='margin-left: 10px'>" +
                                    "       <input type='text' class='sum' value='" +"已选人数:" + res.data.list[i].bz_coll[j].zbz_coll[z].sum + "' style='border:none;' name='sum' readonly='true'>" +
                                    "   </span>" +

                                    '</div>'
                            } else {
                                only += '<div class="xuanxian">' +
                                    '<input type="checkbox" id="checkbox' + a + '" value="' + data.list[i].bz_coll[j].zbz_coll[z].substandardId + '" class="checkbox_"/>' +
