layui.config({
        ...
        $api.Getrecord(req,function (res) {
            ...
            for(var i=0;i<data.list.length;i++){
                ...
                zbt+= '<div class="zibiaotifenquyu">\n' +
                    ...
                    '                    <div class="tup"><img src="" alt="" style=""></div>\n' +
                    '                    <div class="sub">\n' +
    ...
    form.on("submit(tijiao)", function (data) {
        var shangchu = window.sessionStorage.getItem("tijiaozhanghao");
        var sc = JSON.parse(shangchu);
        ...
        console.log(JSON.stringify(updataColl));
