        ...
        $api.Gettemp(req,function (res) {
            ...
            for(var i=0;i<data.list.length;i++){
                ...
                bc+= '<div class="layui-form-item">'+
                    ...
                    '<input type="text" class="layui-input" id="uidData1" name="uname" value="'+renming+'" onclick="openAdduser($(this));" placeholder="选择添加">'+
                    '<input type="hidden" id="uidData1ex" name="uid" value="'+renyuan+'"/>'+
                    '</div>'+
                    '</div>'
