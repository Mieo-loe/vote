...
public class FrameworkController {
    ...
    public IResult getAll(){
        ...
        return new ResultBean<Collection<OrgNodeResponseQue>>(frameworkService.getAll());
    }
    ...
    public IResult get(String fid){
        //返回json至前端的均返回ResultBean或者PageResultBean
        return new ResultBean<FrameworkQue>(frameworkService.getById(fid));
    }
    ...
    @ResponseBody
    public IResult update(FrameworkQue org){
        //返回json至前端的均返回ResultBean或者PageResultBean
    ...
    @ResponseBody
    public IResult add(FrameworkQue org){
        //返回json至前端的均返回ResultBean或者PageResultBean
