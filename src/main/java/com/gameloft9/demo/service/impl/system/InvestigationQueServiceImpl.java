...
import com.gameloft9.demo.dataaccess.dao.system.InvestigationQueMapper;
...
@Service
@Transactional
public class InvestigationQueServiceImpl implements InvestigationQueService {
    @Resource
    private InvestigationQueMapper investigationQueMapper;

    public List<InvestigationQue> findAll2(String page,String limit) {
    ...
    public Boolean add2(InvestigationQue investigationQue) {
        investigationQueMapper.add2(investigationQue);
        return true;
    }

    public Boolean addTotal(TotalQue totalQue) {
